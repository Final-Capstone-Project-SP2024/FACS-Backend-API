...
namespace FireDetection.Backend.Domain.Migrations
{
    ...
    [Migration("20240503065752_Migrate47")]
    partial class Migrate47
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FireDetection.Backend.Domain.Entity.ManualPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 5, 3, 6, 57, 52, 26, DateTimeKind.Utc).AddTicks(6047),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CameraLimited = 8,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2024, 5, 3, 6, 57, 52, 26, DateTimeKind.Utc).AddTicks(6062),
                            IsDeleted = false,
                            LastModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LocationLimited = 10,
                        ...
                        new
                        {
                            ...
                            CameraLimited = 20,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2024, 5, 3, 6, 57, 52, 26, DateTimeKind.Utc).AddTicks(6068),
                            IsDeleted = false,
                            LastModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LocationLimited = 20,
