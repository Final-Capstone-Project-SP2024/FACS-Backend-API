...
namespace FireDetection.Backend.Domain.Migrations
{
    ...
    [Migration("20240316080125_migrate28")]
    partial class migrate28
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FireDetection.Backend.Domain.Entity.ManualPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 3, 16, 8, 1, 25, 152, DateTimeKind.Utc).AddTicks(1641),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CameraLimited = 8,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2024, 3, 16, 8, 1, 25, 152, DateTimeKind.Utc).AddTicks(1643),
                            IsDeleted = false,
                            LastModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LocationLimited = 10,
                        ...
                        new
                        {
                            ...
                            CameraLimited = 20,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2024, 3, 16, 8, 1, 25, 152, DateTimeKind.Utc).AddTicks(1645),
                            IsDeleted = false,
                            LastModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LocationLimited = 20,
