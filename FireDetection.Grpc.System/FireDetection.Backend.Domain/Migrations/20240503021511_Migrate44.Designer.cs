...
namespace FireDetection.Backend.Domain.Migrations
{
    ...
    [Migration("20240503021511_Migrate44")]
    partial class Migrate44
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FireDetection.Backend.Domain.Entity.ManualPlan", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            CreatedDate = new DateTime(2024, 5, 3, 2, 15, 10, 848, DateTimeKind.Utc).AddTicks(2453),
                            IsDeleted = false,
                        ...
                        new
                        {
                            ...
                            CameraLimited = 8,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2024, 5, 3, 2, 15, 10, 848, DateTimeKind.Utc).AddTicks(2468),
                            IsDeleted = false,
                            LastModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LocationLimited = 10,
                        ...
                        new
                        {
                            ...
                            CameraLimited = 20,
                            CreatedBy = new Guid("00000000-0000-0000-0000-000000000000"),
                            CreatedDate = new DateTime(2024, 5, 3, 2, 15, 10, 848, DateTimeKind.Utc).AddTicks(2473),
                            IsDeleted = false,
                            LastModified = new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified),
                            LocationLimited = 20,
